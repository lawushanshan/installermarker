...
- Added Python packager hints for Briefcase, PyInstaller, Nuitka, and cx_Freeze in source-build detection, with recipe propagation and documentation updates.
